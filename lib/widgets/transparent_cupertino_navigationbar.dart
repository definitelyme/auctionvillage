...
const double _kNavBarEdgePadding = 8.0;
...
class TransparentCupertinoNavigationBar extends StatefulWidget implements ObstructingPreferredSizeWidget {
  ...
  @override
  _TransparentCupertinoNavigationBarState createState() => _TransparentCupertinoNavigationBarState();
}
...
class _TransparentCupertinoNavigationBarState extends State<TransparentCupertinoNavigationBar> {
...
class TransparentCupertinoSliverNavigationBar extends StatefulWidget {
  /// Creates a navigation bar for scrolling lists.
  ///
  /// The [largeTitle] argument is required and must not be null.
  const TransparentCupertinoSliverNavigationBar({
    Key? key,
    this.largeTitle,
    this.leading,
    this.automaticallyImplyLeading = true,
  ...
  @override
  State<TransparentCupertinoSliverNavigationBar> createState() => _TransparentCupertinoSliverNavigationBarState();
}

// A state class exists for the nav bar so that the keys of its sub-components
// don't change when rebuilding the nav bar, causing the sub-components to
// lose their own states.
class _TransparentCupertinoSliverNavigationBarState extends State<TransparentCupertinoSliverNavigationBar> {
  late _NavigationBarStaticComponentsKeys keys;
