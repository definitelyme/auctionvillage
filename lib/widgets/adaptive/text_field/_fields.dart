...
extension FormFields on _AdaptiveTextFormInputState {
  Widget get _cupertinoTextField => Disabled(
        ...
        child: CupertinoTextField.borderless(
          ...
          maxLines: widget.obscureText ? 1 : (widget.maxLines ?? widget.minLines),
  ...
  Widget get _cupertinoSearchField => CupertinoSearchTextField(
        // decoration: ,
        backgroundColor: _cupertinoData.fillColor ??
            _cupertinoData.decoration.copyWith(color: widget.validate && widget.errorText != null ? Palette.errorRed : null).color,
        itemColor: widget.itemColor,
        itemSize: widget.itemSize,
        prefixIcon: _cupertinoData.prefix ?? const Icon(CupertinoIcons.search),
        suffixIcon: _cupertinoData.suffix != null && _cupertinoData.suffix is Icon
            ? _cupertinoData.suffix as Icon
        ...
        placeholder: widget.hintText,
        placeholderStyle: _hintTextStyle,
        borderRadius: _cupertinoData.borderRadius,
        suffixMode: _cupertinoData.suffixMode,
        prefixInsets: widget.prefixInsets,
  ...
  Widget get _materialTextFormField => Disabled(
        ...
        child: Material(
          ...
          child: TextFormField(
            ...
            minLines: widget.minLines,
            // maxLines: widget.minLines != null && widget.keyboardType != TextInputType.multiline ? null : widget.maxLines,
            // minLines: widget.minLines,
            expands: widget.minLines == null && widget.maxLines == null ? widget.expands : false,
            maxLength: widget.showMaxLength ? widget.maxLength : null,
            maxLengthEnforcement: widget.showMaxLength ? widget.maxLengthEnforcement : null,
  ...
  Widget get _materialTextField => TextField(
        maxLines: widget.maxLines ?? (widget._textFieldType == TextFieldType.searchfield ? 1 : widget.minLines),
        minLines: widget.minLines,
        expands: widget.minLines == null && widget.maxLines == null ? widget.expands : false,
        maxLength: widget.showMaxLength ? widget.maxLength : null,
        maxLengthEnforcement: widget.showMaxLength ? widget.maxLengthEnforcement : null,
        ...
        enableInteractiveSelection: widget.enableInteractiveSelection,
        obscureText: widget.obscureText,
        autocorrect: widget._textFieldType == TextFieldType.searchfield ? false : widget.autoCorrect,
        autofocus: widget.autoFocus,
        controller: _textEditingController,
        showCursor: widget.showCursor,
        cursorColor: _cursorColor,
