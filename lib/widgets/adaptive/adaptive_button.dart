...
class AdaptiveButton extends StatelessWidget {
  ...
  ///
  /// - `Widget` is the loading indicator.
  ...
  BorderRadius get _borderRadius => borderRadius ?? BorderRadius.circular(Utils.buttonRadius);
  Widget get _buttonChild => Row(
        ...
        children: [
          ...
          //
          Padding(
            padding: _loadingData.isLoading ? EdgeInsets.only(left: 0.02.w) : EdgeInsets.zero,
  ...
  Widget get _loadingIndicator => AnimatedVisibility(
  ...
  static Color get defaultHighlightColor => Colors.black12.withOpacity(0.05);
  static Color get defaultSplashColor => Colors.black12.withOpacity(0.1);
      ...
      cupertino: SizedBox(
        ...
        child: type.when(
          elevated: () => CupertinoButton.filled(
            ...
            child: child?.call(_loadingIndicator) ?? _buttonChild,
          ),
          text: () => DecoratedBox(
